...
try
{
	...
	if (report == null)
		throw new InvalidDataException("Failed to parse support-report.json");
...
{
	Console.WriteLine("SupportReportReader.exe <path-to-report-zip>");
	Console.WriteLine();
	Console.WriteLine("Example:");
	Console.WriteLine("  SupportReportReader.exe C:\\Reports\\rdp-security-stats-20260419-123000-SRV01.zip");
}
